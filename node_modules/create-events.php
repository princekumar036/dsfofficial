...
<body class="">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <div id="venue" class="form-control">
                        </div>
                      </div>
                    </div>
                  <div class="col-md-6 pl-1">
                    <div class="form-group">
                      ...
                      <div id="speaker" class="form-control">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="facebook_link" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="instagram_link" value="">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                          <label for="twitter_link">Twitter link</label>
                          <input type="text" class="form-control" id="twitter_link" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="button" class="btn btn-primary btn-round" onclick="addEvent()">Create Event</button>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script>
      ...
      var venue = new Quill('#venue', {
          theme: 'snow' 
      });
      var speaker = new Quill('#speaker', {
          theme: 'snow' 
      });
      function addEvent(){
          const event_details={
              ...
              venue:venue.root.innerHTML.split(" ").join("&nbsp;"),
              speaker:speaker.root.innerHTML.split(" ").join("&nbsp;"),
          ...
          for(let event_key in event_details){
            form_data.append(event_key, event_details[event_key])
          }
          ...
          axios.post('./controllers/event.php',form_data).then(res => {
              res_data=res.data;
