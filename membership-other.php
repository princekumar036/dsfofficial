        ...
        <header class="font-rbto-cnsd font-bold text-lg bg-gray-300 px-10 py-2 lg:flex justify-between items-center lg:text-xl">
            ...
            <nav id="navmenu" class="hidden text-right lg:block">
                <ul class="lg:flex gap-8 items-center">
                    ...
                    <li class="mt-2 lg:mt-0 lg:hover:scale-105 transition-transform"><a class="navbutton bg-red-800 px-5 py-1 rounded text-white lg:px-10 lg:py-2" href="membership-option.html">JOIN US</a></li>
                </ul>
            </nav>
        </header>
			...
			<div class="px-10 max-w-md mx-auto row d-flex justify-content-center">
				...
				<div class="mb-20">
					...
					<form class="border-2 font-rbto-cnsd px-5 py-10" method="post" action="registration-success.html">
                        ...
                        <div class="mb-3">
							<label class="block font-bold form-label custom-form-label">University*</label>
							<input class="block w-full border-b-2 focus:border-b-black mb-10" name="mobile" maxlength="10"
								type="text" class="form-control custom-form-control" required>
						</div>
                      
                        <div class="mb-3">
                              <label class="block font-bold form-label custom-form-label">Subject*</label>
                              <input class="block w-full border-b-2 focus:border-b-black mb-10" name="mobile" maxlength="10"
                                  type="text" class="form-control custom-form-control" required>
                          </div>
                      
                          <div class="mb-3">
                              <label class="block font-bold form-label custom-form-label">Place of Residence*</label>
                              <input class="block w-full border-b-2 focus:border-b-black mb-10" name="mobile" maxlength="10"
                                  type="text" class="form-control custom-form-control" required>
                          </div>
